...
int main(){
    ...
    printf("Entre com a letra do estado seguido de um número de 01 a 04: ");
    ...
    pib_per_carta1 = (pib_carta1 * 100000000) / populacao_carta1;//logica para a divisão do PIB percapita
    ...
    pib_per_carta2 = (pib_carta1 * 100000000)  / populacao_carta2;//logica para a divisão do PIB percapita
    printf("PIB percapita: R$ %.2f\n", pib_per_carta2);
